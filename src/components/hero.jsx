...
export default function Hero() {
  ...
  const startGlitchEffect = () => {
    ...
    const glitchInterval = setInterval(() => {
      setTitles({
        ...
        title2: generateErrorText(iterations.title2, 'Illustrator', true),  // Pass true for title2
      ...
      if (iterations.title3 > 6) iterations.title3--;
  ...
  const generateErrorText = (iterationsLeft, originalText, isTitle2 = false) => {
    ...
    if (isTitle2) {
        const fixedPattern = 'Illustrator-'; 
