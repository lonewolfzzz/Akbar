...
export default function Services() {
  const expertiseItems = ['Graphic Designer', 'Logo Designer', 'Illustrator', '3D Designer', 'Adobe InDesign'];
  const toolBoxItems = ['Photoshops', 'Adobe Illustrator', 'Canva', 'Blender', 'Figma', 'After Effect', 'Framer Motion'];
    ...
    <>
      ...
      >
        ...
        <div className="space-y-14">
          ...
          <ServiceUi
            title="My expertises."
            description="I focus on all things design and video related."
          ...
          <ServiceUi
            ...
            description="These are my go-to software to make any projects happen."
            items={toolBoxItems}
