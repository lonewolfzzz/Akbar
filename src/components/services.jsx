...
export default function Services() {
  const expertiseItems = ['Designer', 'Animator', 'Illustrator', 'Editor', 'Creator'];
  const toolBoxItems = ['Photoshops', 'Illustrator', 'Canva', 'Blender', 'Figma', 'After Effect', 'Framer Motion'];
