...
export default function About() {
  ...
  useEffect(() => {
    ...
    const options1 = {
      strings: ["Im a work-oriented Specialist in Photoshop. Image Editing, Product Retouching, Photo Manipulation, other editing and design based in Indonesia."],
      typeSpeed: 20,
      backSpeed: 25,
      backDelay: 1000,
      loop: false,
    ...
    const options2 = {
      strings: ["I'm always ready to help you Personal and Business with different types of Photoshop, Lightroom, Illustrator, Canva and AI Generate image Editing, product photo editing and Design work services - highly efficient, reliable, accurate, and the fastest delivery of work."],
      typeSpeed: 20,
      backSpeed: 25,
      backDelay: 1000,
      loop: false,
    ...
    const options3 = {
      strings: ["When I am not designing, I enjoy making a new video on "],
      typeSpeed: 20,
      backSpeed: 25,
      backDelay: 1000,
      loop: false,
              ...
              <motion.p className="text-body-1 text-2xl text-gray-200" variants={itemVariants}>
                ...
                {showTikTokLink && (
                  <a
                    ...
                    href="https://www.tiktok.com/@lonewolfguitar"
                    target="_blank"
