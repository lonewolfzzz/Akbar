              ...
              <div className='grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2'>
                <div className='relative z-0'>
                  <input
                    ...
                    id='name'
                    name='name'
                    className='peer block w-full appearance-none border-0 border-b border-gray-400 bg-transparent px-4 py-2.5 text-white focus:outline-none focus:ring-0 rounded-xl'
                    placeholder=' '
                  />
                  <label 
                ...
                <div className="relative z-0 sm:col-span-2">
                  <textarea
                    ...
                    name="message"
                    rows="5"
                    className="peer block w-full appearance-none border-0 border-b border-gray-400 bg-transparent px-0 py-2.5 text-white focus:outline-none focus:ring-0"
                    placeholder=" "
                  ></textarea>
                  <label
                    htmlFor="message"
          ...
          <div className="w-full grid gap-y-8 text-gray-400">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col space-y-3">
                ...
                <a
                  href="https://trello.com/u/akbarirawan"
                  className="group inline-flex items-center space-x-2 text-xl"
                  target="_blank"
                  rel="noreferrer"
                >
                  <Icon icon="mdi:trello" color="#666" />
                  <span>Trello</span>
                </a>
                <a
